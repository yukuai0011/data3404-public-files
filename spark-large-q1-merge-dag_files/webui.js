...
$(function () {
  ...
  collapseTablePageLoad(
    "collapse-aggregated-activeApps",
  ...
  collapseTablePageLoad(
    "collapse-aggregated-completedApps",
    "aggregated-completedApps"
  );
  collapseTablePageLoad(
    "collapse-aggregated-completedDrivers",
    "aggregated-completedDrivers"
  );
  collapseTablePageLoad(
    "collapse-aggregated-runningExecutors",
    "aggregated-runningExecutors"
  );
  collapseTablePageLoad(
    "collapse-aggregated-runningDrivers",
    "aggregated-runningDrivers"
  );
  collapseTablePageLoad(
    "collapse-aggregated-finishedExecutors",
  ...
  collapseTablePageLoad(
    "collapse-aggregated-runtimeInformation",
    "aggregated-runtimeInformation"
  );
  collapseTablePageLoad(
    "collapse-aggregated-sparkProperties",
    "aggregated-sparkProperties"
  );
  collapseTablePageLoad(
    "collapse-aggregated-hadoopProperties",
    "aggregated-hadoopProperties"
  );
  collapseTablePageLoad(
    "collapse-aggregated-systemProperties",
    "aggregated-systemProperties"
  );
  collapseTablePageLoad(
    "collapse-aggregated-metricsProperties",
    "aggregated-metricsProperties"
  );
  collapseTablePageLoad(
    "collapse-aggregated-classpathEntries",
    "aggregated-classpathEntries"
  );
  collapseTablePageLoad(
    "collapse-aggregated-activeJobs",
    "aggregated-activeJobs"
  );
  collapseTablePageLoad(
    "collapse-aggregated-completedJobs",
    "aggregated-completedJobs"
  );
  collapseTablePageLoad(
    "collapse-aggregated-failedJobs",
    "aggregated-failedJobs"
  );
  collapseTablePageLoad(
    "collapse-aggregated-poolTable",
    "aggregated-poolTable"
  );
  collapseTablePageLoad(
    "collapse-aggregated-allActiveStages",
    "aggregated-allActiveStages"
  );
  collapseTablePageLoad(
    "collapse-aggregated-allPendingStages",
    "aggregated-allPendingStages"
  );
  collapseTablePageLoad(
    "collapse-aggregated-allCompletedStages",
  ...
  collapseTablePageLoad(
    "collapse-aggregated-allFailedStages",
    "aggregated-allFailedStages"
  );
  collapseTablePageLoad(
    "collapse-aggregated-activeStages",
    "aggregated-activeStages"
  );
  collapseTablePageLoad(
    "collapse-aggregated-pendingOrSkippedStages",
    "aggregated-pendingOrSkippedStages"
  );
  collapseTablePageLoad(
    "collapse-aggregated-completedStages",
    "aggregated-completedStages"
  );
  collapseTablePageLoad(
    "collapse-aggregated-failedStages",
    "aggregated-failedStages"
  );
  collapseTablePageLoad(
    "collapse-aggregated-poolActiveStages",
  ...
  collapseTablePageLoad(
    "collapse-aggregated-waitingBatches",
    "aggregated-waitingBatches"
  );
  collapseTablePageLoad(
    "collapse-aggregated-runningBatches",
    "aggregated-runningBatches"
  );
  collapseTablePageLoad(
    "collapse-aggregated-completedBatches",
  ...
  collapseTablePageLoad(
    "collapse-aggregated-completedExecutions",
    "aggregated-completedExecutions"
  );
  collapseTablePageLoad(
    "collapse-aggregated-failedExecutions",
    "aggregated-failedExecutions"
  );
  collapseTablePageLoad(
    "collapse-aggregated-sessionstat",
    "aggregated-sessionstat"
  );
  collapseTablePageLoad("collapse-aggregated-sqlstat", "aggregated-sqlstat");
  collapseTablePageLoad(
    "collapse-aggregated-sqlsessionstat",
    "aggregated-sqlsessionstat"
  );
  collapseTablePageLoad(
    "collapse-aggregated-activeQueries",
    "aggregated-activeQueries"
  );
  collapseTablePageLoad(
    "collapse-aggregated-completedQueries",
