            ...
            headrow[i], "click", sorttable.innerSortFunction = function(e) {
              if (this.className.search(/\bsorttable_sorted\b/) != -1) {
                ...
                for (var j = 0; j < rowlists.length; j++) {
                  if (rowlists[j].className.search(
                          /\bsorttable_sortfwdind\b/) != -1) {
              ...
              for (var j = 0; j < rowlists.length; j++) {
                if (rowlists[j].className.search(/\bsorttable_sortfwdind\b/) !=
                        -1 ||
                    rowlists[j].className.search(/\bsorttable_sortrevind\b/) !=
                        -1) {
                  rowlists[j].parentNode.removeChild(rowlists[j]);
                }
              }
              ...
              // order which is a lot faster because you only do getInnerText
              // once per row
              row_array = [];
