          ...
          if (o && o.container && 0 != o.root.offsetWidth) {
            ...
            (o.shadowTop.style.visibility = h),
              ...
              (!e.verticalScroll ||
                ...
                (o.rightContainer.className =
                  o.rightContainer.className.replace(
            ...
            if ("string" == typeof this.subgroupOrderer) {
              for (t in this.subgroups)
                e.push({
                  subgroup: t,
                  sortField:
                    this.subgroups[t].items[0].data[this.subgroupOrderer],
                });
              e.sort(function (t, e) {
    ...
    function (t, e, i) {
      ...
      !(function (n, s, r, a) {
        ...
        (ut.prototype = {
          ...
          ((void 0 !== n ? n : "undefined" != typeof self ? self : {}).Hammer =
            lt),
          (o = function () {
            return lt;
