...
function renderDagViz(forJob) {
  ...
  if (
    ...
    var message =
      "<b>No visualization information available for this " +
      jobOrStage +
      "!</b><br/>" +
      "If this is an old " +
      jobOrStage +
  ...
  metadataContainer()
    ...
    .each(function () {
      ...
      svg
        .selectAll("g[id=" + stageClusterId + "] g." + opClusterId)
