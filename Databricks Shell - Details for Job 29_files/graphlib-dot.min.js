/*v0.5.2*/ (function e(t, n, r) {
  ...
  3 : [
    function(require, module, exports) {
      ...
      function buildGraph(parseTree) {
        ...
        g.setGraph({});
        _.each(parseTree.stmts,
               function(stmt) { handleStmt(g, stmt, defaultStack) });
        return g
      }
      ...
      function handleSubgraphStmt(g, stmt, defaultStack, sg) {
        ...
        _.each(stmt.stmts, function(s) { handleStmt(g, s, defaultStack, id) });
      ...
      module.exports = function() {
        ...
        function parse(input) {
          var options = arguments.length > 1 ? arguments[1] : {},
              peg$FAILED = {}, peg$startRuleFunctions = {
                start : peg$parsestart,
                graphStmt : peg$parsegraphStmt
              },
              peg$startRuleFunction = peg$parsestart, peg$c0 = [],
              peg$c1 = peg$FAILED, peg$c2 = null, peg$c3 = "{",
              peg$c4 = {type : "literal", value : "{", description : '"{"'},
              peg$c5 = "}",
              peg$c6 = {type : "literal", value : "}", description : '"}"'},
              peg$c7 =
                  function(strict, type, id, stmts) {
                return {
                  type: type, id: id, strict: strict !== null, stmts: stmts
                }
              },
              peg$c8 = ";",
              ...
              peg$c11 =
                  function(type, attrs) {
                return {
                  type: "attr", attrType: type, attrs: attrs || {}
                }
              },
              peg$c12 = "=",
              ...
              peg$c15 =
                  function(id, attrs) {
                return {
                  type: "node", id: id, attrs: attrs || {}
                }
              },
              peg$c16 =
                  function(lhs, rhs, attrs) {
                var elems = [ lhs ];
                for (var i = 0; i < rhs.length; ++i) {
                  elems.push(rhs[i])
                }
                return {
                  type: "edge", elems: elems, attrs: attrs || {}
                }
              },
              peg$c17 =
                  function(id, stmts) {
              ...
              peg$c23 = function(aList) { return aList }, peg$c24 = ",",
              ...
              peg$c29 = function() { return directed }, peg$c30 = void 0,
              peg$c31 = "->",
              ...
              peg$c36 = function(id) { return id }, peg$c37 = ":",
              ...
              peg$c71 = function(
                  sign, dot,
                  after) { return (sign || "") + dot + after.join("") },
              peg$c72 =
                  function(sign, before, after) {
                return (sign || "") + before.join("") +
                       (after ? after[0] : "") +
                       (after ? after[1].join("") : "")
              },
              peg$c73 = '"',
              ...
              peg$c77 = function() { return '"' }, peg$c78 = "\\", peg$c79 = {
                type : "literal",
                value : "\\",
                description : '"\\\\"'
              },
              ...
              peg$c83 = function(id) { return id.join("") }, peg$c84 = "node",
              peg$c85 = {
                type : "literal",
                value : "node",
                description : '"node"'
          ...
          function peg$buildException(message, expected, pos) {
            ...
            function buildMessage(expected, found) {
              function stringEscape(s) {
                ...
                return s.replace(/\\/g, "\\\\")
                    ...
                    .replace(/\f/g, "\\f")
                    .replace(/\r/g, "\\r")
                    .replace(/[\x00-\x07\x0B\x0E\x0F]/g,
                             function(ch) { return "\\x0" + hex(ch) })
                    .replace(/[\x10-\x1F\x80-\xFF]/g,
                             function(ch) { return "\\x" + hex(ch) })
                    .replace(/[\u0180-\u0FFF]/g,
                             function(ch) { return "\\u0" + hex(ch) })
                    .replace(/[\u1080-\uFFFF]/g,
                             function(ch) { return "\\u" + hex(ch) })
              }
            ...
            return new SyntaxError(
                ...
                expected, found, pos, posDetails.line, posDetails.column)
          }
  ...
  5 : [
    function(require, module, exports) {
      var _ = require("lodash"), grammar = require("./dot-grammar"),
    ...
    {"./build-graph" : 3, "./dot-grammar" : 4, lodash : 28}
  ],
  6 : [
    function(require, module, exports) {
  ...
  7 : [ function(require, module, exports) { module.exports = "0.5.2" }, {} ],
  8 : [
    function(require, module, exports) {
      var _ = require("lodash");
      ...
      function writeOne(g) {
        ...
        if (_.isObject(graphAttrs)) {
          _.each(graphAttrs,
                 function(v, k) { writer.writeLine(id(k) + "=" + id(v) + ";") })
        }
        writeSubgraph(g, undefined, writer);
        g.edges().forEach(function(edge) { writeEdge(g, edge, ec, writer) });
        writer.unindent();
        writer.writeLine("}");
      ...
      function writeAttrs(attrs, writer) {
        if (_.isObject(attrs)) {
          var attrStrs = _.map(
              attrs, function(val, key) { return id(key) + "=" + id(val) });
          if (attrStrs.length) {
      ...
      function id(obj) {
        if (typeof obj === "number" ||
            obj.toString().match(UNESCAPED_ID_PATTERN)) {
          return obj
        }
      ...
      Writer.prototype.indent = function() { this._indent += this.INDENT };
      Writer.prototype.unindent =
          function() { this._indent = this._indent.slice(this.INDENT.length) };
      ...
      Writer.prototype.toString = function() { return this._content }
    },
    {lodash : 28}
  ],
  9 : [
    ...
    {"./lib" : 25, "./lib/alg" : 16, "./lib/json" : 26, lodash : 28}
  ],
  10 : [
    function(require, module, exports) {
      var _ = require("lodash");
  ...
  12 : [
    function(require, module, exports) {
      ...
      function dijkstraAll(g, weightFunc, edgeFunc) {
        return _.transform(
            g.nodes(),
            function(acc, v) { acc[v] = dijkstra(g, v, weightFunc, edgeFunc) },
            {})
      }
    },
    {"./dijkstra" : 13, lodash : 28}
  ],
  13 : [
    function(require, module, exports) {
      var _ = require("lodash"),
    ...
    {"../data/priority-queue" : 23, lodash : 28}
  ],
  14 : [
    function(require, module, exports) {
  ...
  15 : [
    function(require, module, exports) {
      ...
      function floydWarshall(g, weightFn, edgeFn) {
        return runFloydWarshall(g, weightFn || DEFAULT_WEIGHT_FUNC,
                                edgeFn || function(v) { return g.outEdges(v) })
      }
  ...
  20 : [
    ...
    {"../data/priority-queue" : 23, "../graph" : 24, lodash : 28}
  ],
  21 : [
    function(require, module, exports) {
      var _ = require("lodash");
      ...
      PriorityQueue.prototype.decrease = function(key, priority) {
        ...
        if (priority > this._arr[index].priority) {
          throw new Error("New priority is greater than current priority. " +
                          "Key: " + key + " Old: " + this._arr[index].priority +
                          " New: " + priority)
        }
      ...
      Graph.prototype.removeNode = function(v) {
        ...
        if (_.has(this._nodes, v)) {
          ...
          if (this._isCompound) {
            ...
            _.each(this.children(v), function(child) { this.setParent(child) },
                   this);
  ...
  27 : [ function(require, module, exports) { module.exports = "0.8.1" }, {} ],
  28 : [
    function(require, module, exports) {
      (function(global) {
        (function() {
          ...
          var contextProps = [
            ...
            "isNaN", "parseInt", "setTimeout"
          ];
          var templateCounter = 0;
          var argsClass = "[object Arguments]", arrayClass = "[object Array]",
              boolClass = "[object Boolean]", dateClass = "[object Date]",
              funcClass = "[object Function]", numberClass = "[object Number]",
              objectClass = "[object Object]", regexpClass = "[object RegExp]",
          ...
          function runInContext(context) {
            ...
            var nativeCreate =
                ...
                nativeIsFinite = context.isFinite, nativeIsNaN = context.isNaN,
            ...
            function baseCreateWrapper(bindData) {
              ...
              var isBind = bitmask & 1, isBindKey = bitmask & 2,
                  isCurry = bitmask & 4, isCurryBound = bitmask & 8, key = func;
              function bound() {
            ...
            function pick(object, callback, thisArg) {
              var result = {};
              if (typeof callback != "function") {
                var index = -1, props = baseFlatten(arguments, true, false, 1),
            ...
            function xor() {
              ...
              while (++index < length) {
                ...
                if (isArray(array) || isArguments(array)) {
                  var result =
                      result
                          ? baseUniq(baseDifference(result, array)
            ...
            function zip() {
              var array = arguments.length > 1 ? arguments : arguments[0],
                  index = -1, length = array ? max(pluck(array, "length")) : 0,
                  result = Array(length < 0 ? 0 : length);
              while (++index < length) {
            ...
            function template(text, data, options) {
              ...
              var imports = defaults({}, options.imports, settings.imports),
                  importsKeys = keys(imports), importsValues = values(imports);
